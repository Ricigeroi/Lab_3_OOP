...
{
    internal static class AddNewDriver
    {
        ...
        public static void hireDriver(string name, string surname, int age, int years_driving)
        {
            Driver driver = new Driver(name, surname, age, years_driving);
        }
    }
}
